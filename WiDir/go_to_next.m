...
% mid_point1 = (antenna_coords1(2,:)+T1)/2;
% mid_point2 = (antenna_coords2(2,:)+T2)/2;
a1 = (norm(antenna_coords1(2,:)-start_point)+norm(T-start_point))/2;
a2 = (norm(antenna_coords2(2,:)-start_point)+norm(T-start_point))/2;
% c1 = norm(antenna_coords1(2,:)-T1)/2;
% c2 = norm(antenna_coords2(2,:)-T2)/2;


% ecc1=c1/a1;
% ecc2=c2/a2;
% [elat1,elon1] = ellipse1(mid_point1(1),mid_point2(2),[a1 ecc1]);   
% plot(elat1,elon1,'color','r');
% hold on;
% axis equal;
% [elat2,elon2] = ellipse1(mid_point2(1),mid_point2(2),[a2 ecc2]);
% plot(elat2,elon2,'color','b');
...
%next_point = (next_point - start_point)*scaler+start_point;
%%
% ecc1=c1/a1;
% ecc2=c2/a2;
% [elat1,elon1] = ellipse1(mid_point1(1),mid_point2(2),[a1 ecc1]);   
