...
ellipse_weight=0.5;
translation_scaling=1.2;
%% Antenna Setting
antenna_spacing=0.2;
antenna_mid_left=-1.0;
antenna_mid_right=1.0;
            ...
            for instance_index = 1:total_instance
                ...
                if ~exist(feature_path)
                    ...
                    for ii =1:n_receivers
                        node_sequence{ii}=round(smoothdata(node_sequence{ii},'movmean',3));
                    end
                    %% tracking virtaual sequence
