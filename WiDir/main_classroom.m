...
%% Antenna Setting
antenna_spacing=0.2;
antenna_mid_left=-2.1;
antenna_mid_right=2.1;
    ...
    for user_index=[1,6,8] %%1,6,8 (6,6,4)
        ...
        for track_index = 1:total_track
            for instance_index = 1:total_instance
                ...
                feature_path = [feature_dir, data_file_name, 'widir.mat'];
                ...
                if ~exist(feature_path)
                    ...
                    if (any([1,2,3]==track_index))
                        for ii =1:n_receivers
                            node_selection_hopping=round(smoothdata(node_sequence{ii},'movmean',7));
                            node_sequence{ii}=node_selection_hopping;
                        end
                    end
                ...
                feature_path = [feature_dir, data_file_name, '_trace_widir','.mat'];
